...
15. now replace the thumbnail image that appears on the course website landing page. This image, currently a placeholder, is defined in the header of your post. To change it you will need to first choose and upload an image, and then change the link in the yaml header
    ...
    layout: post
    date:   2019-03-20
    image: "/conflict_urbanism_sp2022/images/lastname_description2.png"
...
URL: https://centerforspatialresearch.github.io/conflict_urbanism_sp2022/
...
Methods for Spatial Research Tutorials [Page](https://centerforspatialresearch.github.io/methods-in-spatial-research-sp2022/tutorials)

## Office Hours: 

Adam Vosburgh -- akv2118@columbia.edu -- by appointment via [Calendly](https://calendly.com/akv2118/adam-office-hours-sp2022). 
